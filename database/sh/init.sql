...
-- DB =>utf-8
ALTER DATABASE re_test CHARACTER SET utf8 COLLATE utf8_general_ci;
-- transactionLevel read committed
SET
  GLOBAL TRANSACTION ISOLATION LEVEL READ COMMITTED;
-- 모든 re_test 모든 테이블 접근권한 with SuperUser
  GRANT ALL PRIVILEGES ON re_test.* TO dev WITH GRANT OPTION;
-- 적용
  flush privileges;