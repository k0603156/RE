...
module.exports.generateRandomString = (buffSize = 64, encodeType = "base64") => promisify(randomBytes)(buffSize)
  .then((buff) => new Promise((resolve) => {
...
module.exports.generateToken = (email) => jwt.sign(
  {
    email,
  },
